...
class Fraction {
  ...
  public static void main(String[] argv) {
    ...
    Fraction sumOfTwo =new Fraction (f1.numerator*f2.denominator+f2.numerator,f2.denominator);              // Sum of f1 and f2.
    Fraction sumOfThree = new Fraction (f1.numerator*f2.denominator+f2.numerator,f2.denominator); ;             // Sum of f0, f1, and f2.
